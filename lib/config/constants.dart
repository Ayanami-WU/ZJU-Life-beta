...
class ApiConfig {
  // 食堂数据 API
  static const String canteenDataUrl = 'https://canteen.zju.edu.cn/monitor/general_new.php';
  
  // 班车数据 API
  static const String busScheduleUrl = 'https://bccx.zju.edu.cn/schoolbus_wx/api';
