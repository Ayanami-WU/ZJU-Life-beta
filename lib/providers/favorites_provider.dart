...
class FavoritesProvider extends ChangeNotifier {
  ...
  List<FavoriteItem> get canteenFavorites => _favorites
      .where((f) =>
          f.type == FavoriteType.canteen ||
          f.type == FavoriteType.canteenWindow)
      .toList();

  List<FavoriteItem> get busFavorites => _favorites
      .where((f) =>
          f.type == FavoriteType.busRoute || f.type == FavoriteType.busStop)
      .toList();

  List<FavoriteItem> get libraryFavorites => _favorites
      .where((f) =>
          f.type == FavoriteType.libraryRoom ||
          f.type == FavoriteType.librarySeat)
      .toList();
